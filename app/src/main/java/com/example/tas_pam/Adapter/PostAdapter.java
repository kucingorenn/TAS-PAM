package com.example.tas_pam.Adapter;
...
public class PostAdapter extends RecyclerView.Adapter<com.example.tas_pam.Adapter.PostAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, int position) {
        ...
        final com.example.tas_pam.Model.Post post = mPosts.get(position);
        ...
        holder.imageProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((FragmentActivity) mContext).getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new com.example.tas_pam.Fragments.ProfileFragment()).commit();
            }
        });
        ...
        holder.postImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new com.example.tas_pam.Fragments.PostDetailFragment()).commit();
            }
        });
